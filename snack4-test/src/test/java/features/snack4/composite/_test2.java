...
import demo.snack4._models.ComplexModel;
import demo.snack4._models.Person;
...
public class _test2 {
    ...
    public void test3(){
        ...
        String x = oNode.select("$.content.amount_detail.amount_units.name")
                .getArray().stream().map(n->n.getString()).collect(Collectors.joining(","));
