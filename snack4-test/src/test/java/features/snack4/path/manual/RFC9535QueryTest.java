...
public class RFC9535QueryTest {
    ...
    @Test
    public void case1_1() {
        ONode rst = ONode.fromJson(json1).select("$.o['j j']");
    ...
    @Test
    public void case1_2() {
        ONode rst = ONode.fromJson(json1).select("$.o['j j']['k.k']");
        System.out.println(rst.toJson());
    ...
    @Test
    public void case2_1() {
        ONode rst = ONode.fromJson(json2).select("$[*]");
        System.out.println(rst.toJson());
...
//    }
    ...
    @Test
    public void case2_4() {
        ONode rst = ONode.fromJson(json2).select("$.a[*]");
        System.out.println(rst.toJson());
    ...
    @Test
    public void case3_1() {
        ONode rst = ONode.fromJson(json3).select("$[1]");
        System.out.println(rst.toJson());
    ...
    @Test
    public void case3_2() {
        ONode rst = ONode.fromJson(json3).select("$[-2]");
        System.out.println(rst.toJson());
    ...
    @Test
    public void case4_1() {
        ONode rst = ONode.fromJson(json4).select("$[1:3]");
        System.out.println(rst.toJson());
    ...
    @Test
    public void case4_2() {
        ONode rst = ONode.fromJson(json4).select("$[5:]");
        System.out.println(rst.toJson());
    ...
    @Test
    public void case4_3() {
        ONode rst = ONode.fromJson(json4).select("$[1:5:2]");
        System.out.println(rst.toJson());
    ...
    @Test
    public void case4_4() {
        ONode rst = ONode.fromJson(json4).select("$[5:1:-2]");
        System.out.println(rst.toJson());
    ...
    @Test
    public void case4_5() {
        ONode rst = ONode.fromJson(json4).select("$[::-1]");
        System.out.println(rst.toJson());
