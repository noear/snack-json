...
public class JsonPathTest2 {
    ...
    public void test1() {
        ...
        List t7 = n.select("$..book[2]").toBean(List.class);
    ...
    @Test
    public void test6() {
        ONode oNode = ONode.ofJson("{\"data\":{\"title\":{\"updatedTime\":1648799928406,\"schemaType\":\"i\",\"name\":\"testName\"}}}");
    ...
    @Test
    public void test7(){
        ONode oNode = ONode.ofJson("{\"data\":[{\"name\":false,\"value\":1},{\"name\":false,\"value\":2},{\"name\":false,\"value\":3},{\"name\":false,\"value\":4}]}");
